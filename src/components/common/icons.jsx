...
export function BrandBadge({ className = "" }) {
  return (
    <div
      className={`flex shrink-0 items-center justify-center rounded-[10px] bg-[var(--pitch)] font-black tracking-tight text-white ${className}`}
      aria-hidden="true"
    >
      2<span className="text-[#bcd0ff]">X</span>
    </div>
  );
}
...
// ----------------------------------------------------------------------------
// NAV ICONS (bottom tab bar)
// ----------------------------------------------------------------------------
export function IconMatchday({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
...
export function IconBracket({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      <rect x="2" y="5" width="6" height="4" rx="1" />
      <rect x="2" y="15" width="6" height="4" rx="1" />
      <rect x="16" y="10" width="6" height="4" rx="1" />
      <path d="M8 7h2a2 2 0 0 1 2 2v1a2 2 0 0 0 2 2h2" />
      <path d="M8 17h2a2 2 0 0 0 2-2v-1a2 2 0 0 1 2-2h2" />
    </svg>
  );
}
...
export function IconStandings({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden>
      ...
      <path d="M5 4h14M5 4v2a3 3 0 0 0 3 3M19 4v2a3 3 0 0 1-3 3" />
    </svg>
  );
}
