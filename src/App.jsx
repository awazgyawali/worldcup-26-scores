...
function HeaderToolbar({ isViewingSelf, locked, canLock, lockTooltip, onOpenLock, onReset, isAnonymous, linkingGoogle, onConnectGoogle }) {
  return (
...
// NAME + FRIENDS MODALS
// ----------------------------------------------------------------------------
function NameModal({ onSubmit, onConnectGoogle, linkingGoogle }) {
